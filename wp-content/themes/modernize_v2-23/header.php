...
<header class="header">
	<div class="container">
		<div class="header-wrapper">
			...
			<!-- Logo -->
			<div class="sixteen columns mt0 logo-wrapper">
				<?php
					echo '<a href="';
					echo  bloginfo('url');
					echo '">';
					...
					echo '<img class="logo" src="' . $logo_attachment . '" alt="' . $alt_text . '"/>';
					echo '</a>';
				?>
			</div>
			<!-- Get Social Icons -->
				...
				<div class="social-wrapper">
					<?php
						...
						if( !empty($gdl_social_wrapper_text) ){
							...
							echo '<div class="slogan social-wrapper-text">' . $gdl_social_wrapper_text . '</div>';
		...
		<div class="sixteen columns mt0">
			<?php 
				if( $gdl_is_responsive ){
					echo '<div class="navigation-wrapper-responsive">';
					dropdown_menu( array('menu' => 'main_menu', 'dropdown_title' => 'Donator', 'indent_string' => '- ', 'indent_after' => '','container' => 'div', 'container_class' => 'responsive-menu-wrapper', 'theme_location'=>'main_menu') );
					echo '</div>';
				}
			?>
			<div class="navigation-wrapper">
				<!-- Get Navigation -->
				<?php wp_nav_menu( array('menu' => 'main_menu', 'container' => 'div', 'container_class' => 'menu-wrapper', 'container_id' => 'main-superfish-wrapper', 'menu_class'=> 'sf-menu',  'theme_location' => 'main_menu' ) ); ?>
